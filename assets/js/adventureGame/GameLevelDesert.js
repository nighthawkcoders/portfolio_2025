...
class GameLevelDesert {
    constructor(gameEnv) {
        ...
        // R2D2 as Enemy Data
        const sprite_src_r2d2_enemy = path + "/images/gamify/r2_idle.png"; // be sure to include the path
        const sprite_data_r2d2_enemy = {
            id: 'StarWarsR2D2Enemy',
            src: sprite_src_r2d2_enemy,
            SCALE_FACTOR: 8,
            ANIMATION_RATE: 100,
        ...
        this.classes = [
            ...
            { class: Enemy, data: sprite_data_r2d2_enemy }, // R2D2 as Enemy
