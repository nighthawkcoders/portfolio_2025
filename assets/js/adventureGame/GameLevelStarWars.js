...
class GameLevelStarWars {
  constructor(gameEnv) {
    ...
    const sprite_src_snowspeeder = path + "/images/gamify/snowspeeder.png"; // be sure to include the path
    ...
    const sprite_data_snowspeeder = {
        ...
        pixels: {height: 720, width: 180},
        orientation: {rows: 4, columns: 1 },
        down: {row: 0, start: 0, columns: 1 },
        downRight: {row: 0, start: 0, columns: 1, rotate: 7*Math.PI/4 },
        downLeft: {row: 0, start: 0, columns: 1, rotate: Math.PI/4 },
        left: {row: 2, start: 0, columns: 1 },
        right: {row: 1, start: 0, columns: 1 },
        up: {row: 3, start: 0, columns: 1 },
        upLeft: {row: 3, start: 0, columns: 1, rotate: 7*Math.PI/4 },
        upRight: {row: 3, start: 0, columns: 1, rotate: Math.PI/4 },
        idleUp: {row: 3, start: 0, columns: 1 },
        idleDown: {row: 0, start: 0, columns: 1 },
        idleLeft: {row: 2, start: 0, columns: 1 },
        idleRight: {row: 1, start: 0, columns: 1 },
